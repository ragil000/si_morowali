	...
	<div class="header clearfix">
		<div class="header-right">
			<div class="brand-logo">
				<a href="index.php">
					<img src="<?=base_url()?>public/template/vendors/images/deskapp-logo.png" alt="" class="mobile-logo">
				</a>
			</div>
			<div class="menu-icon">
				<span></span>
...
<!--
			<p class="text-info pull-left pd-20" style="font-size:140%;">Sistem Informasi Satuan Harga Kode Aset</p>-->
			<div class="user-info-dropdown pull-right">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="<?=base_url()?>admin/logout"><i class="fa fa-sign-out" aria-hidden="true"></i> Log Out</a>
					</div>
				</div>
			</div>
			<!--
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="< ?=base_url()?>public/template/vendors/images/img.jpg" alt="">
