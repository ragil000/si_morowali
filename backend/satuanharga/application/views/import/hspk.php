					...
					for ($l=0; $l < count($hspk4); $l++) { 
						echo '<tr>
								...
								<td style="border: 1px solid; padding: 10px;">'.$hspk4[$l]['Uraian_Kegiatan'].'</td>
									<td style="border: 1px solid; padding: 10px;">'.$this->fungsi->convert_to_rupiah($hspk4[$l]['HargaZona1']).'</td>
									<td style="border: 1px solid; padding: 10px;">'.$this->fungsi->convert_to_rupiah($hspk4[$l]['HargaZona2']).'</td>
									<td style="border: 1px solid; padding: 10px;">'.$this->fungsi->convert_to_rupiah($hspk4[$l]['HargaZona3']).'</td>
									<td style="border: 1px solid; padding: 10px;">'.$this->fungsi->convert_to_rupiah($hspk4[$l]['HargaZona4']).'</td>
									<td style="border: 1px solid; padding: 10px;">'.$hspk4[$l]['Uraian'].'</td>
