			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-1">
						<div class="pull-left">
							<h4 class="text-blue">Kode SSH 1</h4>
						</div>
					</div>
					<hr>
						...
						<div class="pull-right">
							<form action="<?=base_url()?>admin/ssh1/page-1">
								<div class="form-group has-success">
									<input type="text" class="form-control form-control-success" name="search" placeholder="Pencarian Uraian SSH 1" value="<?=$search?>" size="25">
								</div>
							</form>
						</div>
						<div class="pull-left">
										...
										<div class='dropdown'>
											<a class='btn btn-outline-primary dropdown-toggle btn-sm' href='#' role='button' data-toggle='dropdown'>
											  ...
											  <div class='dropdown-menu dropdown-menu-right '>
												<a class='dropdown-item' data-uid='".$data['Kd_Ssh1']."'
												data-str='".$data['Nm_Ssh1']."'
						...
						<form id="sshForm" method="POST" action="" enctype="multipart/form-data" >
							...
							<div class="modal-body" id="sshData">
								<div class="form-group row">
									...
									<div class="col-12">
										<label class="col-sm-12 col-form-label">Uraian SSH 1</label>
										<div class="col-sm-12">
			...
			<div class="modal fade bs-example-modal-lg" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" >Tampil Kode SSH 1</h4>
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						</div>
						<div class="modal-body" id="sshData">
