			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-1">
						<div class="pull-left">
							<h4 class="text-blue">Kode HSPK 2 </h4>
						</div>
					</div>
					<hr>
					<div class="clearfix mb-10">
						<div class="pull-right">
							<form action="<?=base_url()?>admin/hspk2/page-1">
								<div class="form-group has-success">
									<input type="text" class="form-control form-control-success" name="search" placeholder="Pencarian Uraian HSPK 2" value="<?=$search?>" size="25">
								</div>
							</form>
						</div>
						<div class="pull-left">
						...
						<table class="table table-striped table-hover ">
							...
							<tbody>
								...
								<tr>
									...
									<td>".$data['Nm_Hspk1']."</td>
									<td>".$data['Kd_Hspk1'].".".$data['Kd_Hspk2']."</td>
									<td>".$data['Nm_Hspk2']."</td>
									<td>
										<div class='dropdown'>
											<a class='btn btn-outline-primary dropdown-toggle btn-sm' href='#' role='button' data-toggle='dropdown'>
											  ...
											  <div class='dropdown-menu dropdown-menu-right '>
												...
												data-uid='".$data['Kd_Hspk1'].".".$data['Kd_Hspk2']."'
												data-str='".$data['Nm_Hspk1'].":".$data['Nm_Hspk2']."'
							...
							<div class="modal-body" id="hspkData">
								<div class="form-group row">
									<div class="col-6">
										...
										<div class="col-sm-12">
											<select class="form-control" id="kode-hspk1" name="kode_hspk1" required autofocus>  <!-- variabel -->
											</select>
										</div>
									</div>
									<div class="col-6">
										...
										<div class="col-sm-12">
											<input class="form-control" type="text" id="kode-hspk2" name="kode_hspk2" required autofocus disabled> <!-- var -->
											</div>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-12">
										<label class="col-sm-12 col-form-label">Uraian HSPK 2</label>
										<div class="col-sm-12">
											<input class="form-control" type="text" id="nm-hspk2" name="nm_hspk2" required autofocus disabled> <!-- var -->
											</div>
									</div>
								</div>
							</div>
			...
			<div class="modal fade bs-example-modal-lg" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" >Tampil Kode HSPK 2</h4>
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						</div>
						<div class="modal-body" id="hspkData">
