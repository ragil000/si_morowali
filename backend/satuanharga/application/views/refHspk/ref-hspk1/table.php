			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-1">
						<div class="pull-left">
							<h4 class="text-blue">Kode HSPK 1 </h4>
						</div>
					</div>
					<hr>
					<div class="clearfix mb-10">
						<div class="pull-right">
							<form action="<?=base_url()?>admin/hspk1/page-1">
								<div class="form-group has-success">
									<input type="text" class="form-control form-control-success" name="search" placeholder="Pencarian Uraian HSPK 1" value="<?=$search?>" size="25">
								</div>
							</form>
						</div>
						<div class="pull-left">
										...
										<div class='dropdown'>
											<a class='btn btn-outline-primary dropdown-toggle btn-sm' href='#' role='button' data-toggle='dropdown'>
											  ...
											  <div class='dropdown-menu dropdown-menu-right '>
												<a class='dropdown-item' data-uid='".$data['Kd_Hspk1']."'
												data-str='".$data['Nm_Hspk1']."'
							...
							<div class="modal-body" id="hspkData">
								<div class="form-group row">
									<div class="col-12">
										...
										<div class="col-sm-12">
											<input class="form-control" type="text" id="kode-hspk1" name="kode_hspk1" required autofocus disabled> <!-- var -->
											</div>
									</div>
									<div class="col-12">
										<label class="col-sm-12 col-form-label">Uraian HSPK 1</label>
										<div class="col-sm-12">
											<input class="form-control" type="text" id="nm-hspk1" name="nm_hspk1" required autofocus disabled> <!-- var -->
											</div>
									</div>
								</div>
							</div>
			...
			<div class="modal fade bs-example-modal-lg" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" >Tampil Kode HSPK 1</h4>
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						</div>
						<div class="modal-body" id="hspkData">
