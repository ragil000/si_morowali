			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-1">
						<div class="pull-left">
							<h4 class="text-blue">Kode ASB 4</h4>
						</div>
					</div>
					<hr>
					<div class="clearfix mb-10">
						<div class="pull-right">
							<form action="<?=base_url()?>admin/asb4/page-1">
								<div class="form-group has-success">
									<input type="text" class="form-control form-control-success" name="search" placeholder="Pencarian Uraian ASB 4" value="<?=$search?>" size="25">
								</div>
							</form>
						</div>
						<div class="pull-left">
							...
							<tbody>
								<?php
									foreach ($asb as $data) {
										echo "
								<tr>
									<td>".$data['Kd_Asb1'].".".$data['Kd_Asb2'].".".$data['Kd_Asb3'].".".$data['Kd_Asb4']."</td>
									<td>".$data['Nm_Asb4']."</td>
									<td>
										<div class='dropdown'>
											<a class='btn btn-outline-primary dropdown-toggle btn-sm' href='#' role='button' data-toggle='dropdown'>
											  ...
											  <div class='dropdown-menu dropdown-menu-right '>
												...
												data-uid='".$data['Kd_Asb1'].".".$data['Kd_Asb2'].".".$data['Kd_Asb3'].".".$data['Kd_Asb4']."'
												data-str='".$data['Nm_Asb1'].":".$data['Nm_Asb2'].":".$data['Nm_Asb3'].":".$data['Nm_Asb4']."'
					...
					<div class="modal-content">
						<form id="asbForm" method="POST" action="" enctype="multipart/form-data" >
							...
							<div class="modal-body" id="asbData">
								...
								<div class="form-group row">
									<div class="col-6">
										<label class="col-sm-12 col-form-label">Nama ASB 3</label>
										<div class="col-sm-12">
											<select class="form-control" id="kode-asb3" name="kode_asb3" required autofocus>  <!-- variabel -->
											</select>
										</div>
									</div>
									<div class="col-6">
										...
										<div class="col-sm-12">
											<input class="form-control" type="text" id="kode-asb4" name="kode_asb4" required autofocus disabled> <!-- var -->
										</div>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-12">
										<label class="col-sm-12 col-form-label">Uraian ASB 4</label>
										<div class="col-sm-12">
											<input class="form-control" type="text" id="nm-asb4" name="nm_asb4" required autofocus disabled> <!-- variabel -->
											</div>
									</div>
								</div>
							</div>
			...
			<div class="modal fade bs-example-modal-lg" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" >Tampil Kode ASB 4</h4>
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						</div>
						<div class="modal-body" id="asbData">
