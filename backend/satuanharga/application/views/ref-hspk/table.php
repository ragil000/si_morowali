							...
							<tbody>
								<?php
									foreach ($ssh as $data) {
										...
										echo "
								<tr>
									<td><a href='javascript:void(0)' data-id='".$data['Kd_Hspk1']."-".$data['Kd_Hspk2']."-".$data['Kd_Hspk3']."-".$data['Kd_Hspk4']."' onclick='viewTable(this)'><i class='fa fa-caret-square-o-down'></i></a></td>
								...
								<tr  style='background-color: #ffffff;' >
									<td id='table-view-".$data['Kd_Hspk1']."-".$data['Kd_Hspk2']."-".$data['Kd_Hspk3']."-".$data['Kd_Hspk4']."' style='display: none;'>
										<table class='table table-bordered'  id='tableTampil-".$data['Kd_Hspk1']."-".$data['Kd_Hspk2']."-".$data['Kd_Hspk3']."-".$data['Kd_Hspk4']."'>
											<thead>
												<tr>
													<th></th>
													<th>Nomor</th>
