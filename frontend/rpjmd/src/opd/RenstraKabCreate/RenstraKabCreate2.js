...
edit(data){
  ...
  this.setState({dataPilih:this.dataPilihAwal, edit:data.perumusan_program_id});
}
        ...
        <div>
          ...
          <thead style={{textAlign: 'center', backgroundColor:'#0066ff', color: 'white'}}>
            ...
            {this.state.dataAll.map((data, key) => {
              if(data.perumusan_program_id !== this.state.edit){
                return data ? (
                  <tr key={key}>
                ...
                return data ? (
                  ...
                  <td>{data.tujuan_nama}</td>
                    ...
                    <td>{data.Ket_Program}</td>
                    <td>
                      <Input type="select" value={data.Kd_Keg} data-number="1" onChange={this.handleChange(key)} required autoFocus >
                    ...
                    <td>{data.outcome}</td>
                    <td>
                      <Input type="text" value={data.outcome_kegiatan} data-number="2" onChange={this.handleChange(key)}/>
                    </td>
                    <td>{data.kondisi_awal}</td>
                    <td>{data.target1_tahun}</td>
                    <td>{data.target1_satuan_nama}</td>
