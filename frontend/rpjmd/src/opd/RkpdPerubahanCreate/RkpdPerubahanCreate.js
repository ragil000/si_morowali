...
class RkpdPerubahanCreate extends Component {
  ...
  constructor(props) {
    ...
    document.title = "Menyusun RKPD Perubahan";
    this.link = 'opd/menyusun/rkpd-perubahan';
...
// isi
  isi(){
    if(this.state.loading){
      ...
      return(
        <div>
          <PraRkaCreate name="namaku" tahun={this.state.dataTambah.tahun} perubahan={true} bappeda={true} data={this.state.dataPilih} lihatRkaKeluar={()=>{this.setState({lihatRka:false});window.location.reload();}} />
        </div>
      );
    }else{
      return(
...
export default RkpdPerubahanCreate;
