...
class ProgramKegiatan extends Component {
  ...
  getData = (page = 1) => {
    ...
    axios
    .post(config.apiRoot+'akun/page-'+page, data)
    .then(response => {
          ...
          <Col xs="12" lg="12">
            <Card>
              ...
              <CardBody>
                ...
                <Col xs="12" md="2">
                  <Button color="info" onClick={() => {this.setState({aksi:'Tambah'});this.toggle();}} className="mr-1">Tambah</Button>
                </Col>   
                </Row>      
                <Table responsive striped>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Pendidikan</td>
                      <td>Program peningkatan Mutu</td>
                      <td>pelaksanaan sertivikasi pendidikan</td>
                      <td>
