...
class ViewPerumusanStrategi extends Component {
  ...
  constructor(props) {
    ...
    document.title = "Menyusun Perumusan Strategi dan Arah Kebijakan Pembangunan";
    ...
    if(this.state.loading){
      ...
      return(
        <div>
          ...
          <Row>
            <Col xs="128" md="10">
            <Download link="rpjmd/menyusun/strategi-kebijakan"/>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    <ModalBody>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="6" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.strategi_pembangunan} required autoFocus/>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="7" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.arah_kebijakan} required autoFocus/>
