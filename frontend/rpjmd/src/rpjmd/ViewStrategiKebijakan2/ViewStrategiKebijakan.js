          ...
          <Col xs="12" lg="12">
            <Card>
              <CardBody>
                ...
                <Row> 
                  <Col md="1"><h5>Visi</h5></Col>
                  <Col xs="12" md="9"> <h5>: {this.state.visi}</h5></Col>
                </Row>
              </CardBody>
                  ...
                  <Row>
                    <Col  xs="12" lg="5">
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="select" name="status" data-number="1" onChange={this.handleChange} value={this.state.urusan} >
                    ...
                    <Col  xs="12" lg="7">
                      <FormGroup row>
                        <Col xs="9" md="9">
                          <Input type="select" name="status" data-number="2" onChange={this.handleChange} value={this.state.bidang}  >
                          <option key="-1" value="">-= Pilih Urusan =-</option>
