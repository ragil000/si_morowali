...
class ViewPerumusanStrategi extends Component {
...
// submit
  handleSubmit = event => {
    ...
    data.append('session', localStorage.getItem('codexv-session'));
    data.append('rpjmd', localStorage.getItem('codexv-rpjmd'));
    data.append('tujuan_sasaran_kondisi_awal', this.state.dataPilih.tujuan_sasaran_id);
  ...
  handleDelete = () =>{
    ...
    data.append('session', localStorage.getItem('codexv-session'));
    data.append('rpjmd', localStorage.getItem('codexv-rpjmd'));
    data.append('tujuan_sasaran_id', this.state.dataPilih.isu_strategi_id);
    axios
            ...
            {this.state.dataAll.map((data, key) => {
              return data ? (
                <tr key={key}>
                  ...
                  <td>{data.target2_satuan}</td>
                  <td>{data.target3_tahun}</td>
                  <td>{data.target3_satuan}</td>
                  <td>{data.target4_tahun}</td>
                  <td>{data.target4_satuan}</td>
                  <td>{data.target5_tahun}</td>
                  <td>{data.target5_satuan}</td>
                  <td>
                ...
                <Modal isOpen={this.state.modalCreate} toggle={this.modalCreateClose} className={'modal-lg ' + this.props.className}>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="1" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.misi_id} required autoFocus/>
                          <FormText color="muted">Misi</FormText>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="3">
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" data-number="2" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.isu_strategi_rpjmd} required autoFocus/>
                          <FormText color="muted">Isi Isu Strategis RPJMD</FormText>
                        </Col>
                      </FormGroup>                    
                      <FormGroup row>
                        <Col md="3">
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="6" md="3">
                          ...
                          <Col xs="6" md="4">
                            <Input type="select" data-number="8" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.Kd_Satuan} required autoFocus>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="6" md="3">
                          ...
                          <Col xs="6" md="4">
                            <Input type="select" data-number="10" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.Kd_Satuan} required autoFocus>
                            <option key="-1" value="">-= Pilih Satuan =-</option>
                            {this.state.dataSatuan.map((data, key) => {
                              return data ? (
                                <option key={key} value={data.Kd_Satuan}>{data.Uraian}</option>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="6" md="3">
                          ...
                          <Col xs="6" md="4">
                            <Input type="select" data-number="12" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.Kd_Satuan} required autoFocus>
                            <option key="-1" value="">-= Pilih Satuan =-</option>
                            {this.state.dataSatuan.map((data, key) => {
                              return data ? (
                                <option key={key} value={data.Kd_Satuan}>{data.Uraian}</option>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="6" md="3">
                          ...
                          <Col xs="6" md="4">
                            <Input type="select" data-number="14" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.Kd_Satuan} required autoFocus>
                            <option key="-1" value="">-= Pilih Satuan =-</option>
                            {this.state.dataSatuan.map((data, key) => {
                              return data ? (
                                <option key={key} value={data.Kd_Satuan}>{data.Uraian}</option>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="6" md="3">
                          ...
                          <Col xs="6" md="4">
                            <Input type="select" data-number="16" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.Kd_Satuan} required autoFocus>
                            <option key="-1" value="">-= Pilih Satuan =-</option>
                            {this.state.dataSatuan.map((data, key) => {
                              return data ? (
                                <option key={key} value={data.Kd_Satuan}>{data.Uraian}</option>
...
export default ViewPerumusanStrategi;
