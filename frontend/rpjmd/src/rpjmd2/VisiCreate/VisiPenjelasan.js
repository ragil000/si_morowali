            ...
            <Col xs="12" lg="12">
              <Card>
                ...
                <CardBody>
                  ...
                  <Row>
                  <Col xs="128" md="10">
                  <Form method="post" action={config.apiRoot+'rpjmd/menyusun/visi-penjelasan/save/pdf'}>
                  ...
                  <Form method="post" action={config.apiRoot+'rpjmd/menyusun/visi-penjelasan/save/excel'}>
                    <Input type="hidden" name="session" value={localStorage.getItem('codexv-session')}/>
                    <Input type="hidden" name="rpjmd" value={localStorage.getItem('codexv-rpjmd')}/>
                    <Input type="hidden" name="search" value={this.state.pencarian}/>
                    <Button color="primary" >Excel</Button>
                  </Form>
