...
class StrategiCreate extends Component {
...
/// set data
  ...
  getData = (page = 1) => {
    ...
    axios
    .post(config.apiRoot+'rpjmd/menyusun/strategi/page-'+page, data)
    .then(response => {
...
// submit
  handleSubmit = event => {
    ...
    if(this.state.aksi === 'Edit'){
      link = config.apiRoot+'rpjmd/menyusun/strategi/update';
      
    }else if(this.state.aksi === 'Tambah'){
      link = config.apiRoot+'rpjmd/menyusun/strategi/create';
    }
  ...
  handleDelete = () =>{
    ...
    data.append('id', this.state.dataPilih.strategi_id);
    axios
    .post(config.apiRoot+'rpjmd/menyusun/strategi/delete', data)
    .then(response => {
      if(response.data.status){
        this.modalDelete();
        this.getData();
        ...
        <div>
          ...
          <Table responsive striped>
            ...
            <tr>
              ...
              <th>Program</th>
              <th>Indikator Kinerja (Outcome)</th>
              <th>OPD</th>
              <th>Aksi</th>
            </tr>
            </thead>
                ...
                <Modal isOpen={this.state.modalCreate} toggle={this.modalCreateClose} className={'modal-lg ' + this.props.className}>
                  ...
                  <Form method="post"  onSubmit={this.handleSubmit} className="form-horizontal" id="form-data">
                    ...
                    <FormGroup row>
                      ...
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="select">Pilih OPD *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          <Input type="select" data-number="8" onChange={this.handleChange} value={this.state.dataPilih.opd} required autoFocus>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="select" data-number="2" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.indikator_id} required autoFocus>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="text" id="kebijakan" data-number="3" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.kebijakan_nama} required autoFocus/>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input type="select" data-number="6" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.program} required autoFocus>
                          <option key="-1" value="">-= Pilih Program =-</option>
                          {this.state.dataProgram.map((data, key) => {
                            return data ? (
                              <option key={key} value={data.Kd_Program}>{data.Nm_Program}</option>
                            ) : (null);
                          })}
                          </Input>
                      ...
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="text-input">Indikator Kinerja (Outcome) *</Label>
                        </Col>
                        <Col xs="12" md="9">
                          <Input type="text" id="kebijakan" data-number="7" placeholder="" onChange={this.handleChange} value={this.state.dataPilih.outcome_nama} required autoFocus/>
                          <FormText color="muted">Isi Outcome</FormText>
                        </Col>
                      </FormGroup>
                    </ModalBody>
                    <ModalFooter>
